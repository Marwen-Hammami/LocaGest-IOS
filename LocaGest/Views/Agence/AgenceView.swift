...
struct AgenceView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationBarTitle("Mes Agences")
        }
    }
}
...
let agencies = [
    ...
    Agence(agenceName: "Agence Bardo", adresse: "50 Avenue des beaux arts, Tunis",idHead: "1",longitude : "56,6,656",latitude: "648468,6546,66"),
